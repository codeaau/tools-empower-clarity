export type ReferenceType = "url" | "book" | "article" | "web" | "report" | "paper" | "dataset" | "other";
...
export type EventKind = "Create" | "TagAdd" | "TagRemove" | "UpdateMeta" | "Relate" | "Snapshot";
...
export interface RelateEvent extends BaseEvent {
    ...
    payload: {
        targetId: string;
        relation: "cites" | "extends" | "duplicates" | "references" | "related";
    };
}
...
export type RefEvent = CreateEvent | TagAddEvent | TagRemoveEvent | UpdateMetaEvent | RelateEvent | SnapshotEvent;
export interface ProjectionState {
    ref?: Reference;
    relations: Array<{
        targetId: string;
        relation: RelateEvent["payload"]["relation"];
    }>;
}
